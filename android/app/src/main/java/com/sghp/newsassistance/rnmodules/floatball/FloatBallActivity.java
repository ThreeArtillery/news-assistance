...
import com.sghp.newsassistance.R;

/**
 * Created by xp on 2017/4/5.
 */

public class FloatBallActivity extends FrameLayout {
    ...
    public FloatBallActivity(Context context) {
        this(context, null);
    }

    public FloatBallActivity(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FloatBallActivity(Context context, AttributeSet attrs, int defStyleAttr) {
